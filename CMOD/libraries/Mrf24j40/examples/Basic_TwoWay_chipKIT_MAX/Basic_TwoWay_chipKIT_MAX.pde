...
const int pin_reset = 48;      //MAX
const int pin_cs = 53;           // MAX
const int pin_interrupt = 2;   // MAX INT1
...
void setup() {
  ...
  attachInterrupt(1, interrupt_routine, FALLING); // interrupt 1 equivalent to MAX pin 36(INT1) 
  interrupts();
}

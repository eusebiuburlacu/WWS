...
HD_PWD='F:/Proiecte_si_concursuri/WWS/WWS/ZYBO/zybo_vivado_proj/zybo_vivado_proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_hw_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source design_hw_wrapper.tcl -notrace

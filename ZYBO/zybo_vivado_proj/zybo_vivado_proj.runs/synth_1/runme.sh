...
HD_PWD='F:/Proiecte_si_concursuri/WWS/WWS/ZYBO/zybo_vivado_proj/zybo_vivado_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_hw_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source design_hw_wrapper.tcl
